...
/* PLANNER */
.ws-planner { padding: 0 32px 12px; overflow-x: auto; }
...
@media (max-width: 768px) {
  ...
  .ws-planner { padding: 0 0 10px; width: 100%; max-width: 100%; box-sizing: border-box; }
...
@media (max-width: 480px) {
  ...
  .ws-planner { padding: 0 2px 8px; width: 100%; max-width: 100%; }
